...
image: 'https://raw.githubusercontent.com/elcaza/misc/refs/heads/main/blog/hacking/hacking_ios/portada.png'
tags: [Hacking, iOS]
category: 'Hacking'
draft: false 
lang: 'es'
...
************************************************************************************************
# Transmisión de pantalla a computadora
+ Airdroid
	+ https://www.airdroid.com/es/pricing/airdroid-cast/
...
************************************************************************************************
# Guardado de información en iOS

Seguros:
+ Keychain => Clave-Valor Seguro => Información confidencial (contraseñas)

Bases de datos:
+ Couchbase Lite => Base de Datos NoSQL => Aplicaciones "offline-first" con sincronización
+ YapDatabase => Clave-Valor con SQL => Alto rendimiento para colecciones de objetos
+ Realm => Base de Datos Objeto => Alternativa de alto rendimiento a Core Data
+ Core Data => ORM (Object-Relational) => Gestión de datos complejos a gran escala

Otros:
+ Plist => Archivo de configuración => Datos estáticos, de solo lectura
+ UserDefaults => Clave-Valor => Preferencias y ajustes simples
+ Webkit Caching => Caché Temporal => Contenido de páginas web

************************************************************************************************
# Problemas & Soluciones

## Mi aplicación se cierra tras abrirla 
1. Si has instalado desde `Filza`. Desinstala la aplicación e instalala desde `TrollStore` 
